!(function(e, t) {
  ...
  function X(e, t, n) {
    ...
    return (
      t === Y && (e = G(e, fe(e) % 10, 'year')),
      t === B && (e = G(e, fe(e) % 100, 'year')),
      t === H &&
        (e = (function(e, t, n) {
          var r = (ce(e) + 7 - (n || 0)) % 7
  ...
  function q(e, t, n) {
    return (e = G((e = $((e = X((e = new Date(e)), t, n)), 1, t)), 1, F))
  }
  ...
  function Ee(e, t, n) {
    return n && 'milliseconds' !== n
      ? Math.round(Math.abs(+X(e, n) / he[n] - +X(t, n) / he[n]))
      : Math.abs(+e - +t)
  }
  function _e(e, t, n) {
    var r = -1,
  ...
  function qe(e, t, n) {
    ...
    var r = typeof t
    return (
      !!('number' == r ? Be(n) && Xe(t, n.length) : 'string' == r && t in n) &&
      Oe(n[t], e)
    )
  }
  function Ke(e) {
  ...
  function Je(e) {
    return 'symbol' == typeof e || (Ke(e) && Fe(e) == Ze)
  }
  var Qe = NaN,
    et = /^\s+|\s+$/g,
    tt = /^[-+]0x[0-9a-f]+$/i,
        ...
        return r.createElement(
          ...
          n.map(function(t, n) {
            return r.createElement(Pt, {
              ...
              components: c,
              onDoubleClick: u,
              continuesPrior: Q(s.end(t), f, 'day'),
              continuesAfter: J(s.start(t), d, 'day'),
              slotStart: f,
              slotEnd: d,
              selected: Ft(t, o),
              draggable: !0,
  ...
  function mn(e) {
    ...
    for (var t = e.parentElement; t && 'none' === Xt(t, 'transform'); )
      t = t.parentElement
  ...
  function Pn(e) {
    var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
      n = Rn.indexOf(e),
      r = Rn.slice(n + 1).concat(Rn.slice(0, n))
      ...
      M = (function(e, n, r) {
        ...
        Ht({}, l, {
          ...
          modifiers: Ht({}, S, {
            ...
            arrow: Ht({}, S.arrow, { enabled: !!m, element: m }),
  ...
  function Wr(e) {
    return (
      !(!Le(e) || ((t = e), Cr && Cr in t)) && (Ue(e) ? zr : Rr).test(Ar(e))
    )
    var t
  }
  function Hr(e, t) {
  ...
  var Ao = Object.prototype,
    Ro = Ao.hasOwnProperty,
    Po = Ao.propertyIsEnumerable,
    Fo = ko(
      (function() {
        return arguments
      })()
      ...
      ? ko
      : function(e) {
          return Ke(e) && Ro.call(e, 'callee') && !Po.call(e, 'callee')
        }
  ...
  var Vo = 'object' == typeof e && e && !e.nodeType && e,
    ...
    Bo = Yo && Yo.exports === Vo && Se.process,
    $o = (function() {
      try {
    ...
    Xo = Go
      ? Uo(Go)
      : function(e) {
          return Ke(e) && Ye(e.length) && !!Ho[Fe(e)]
        },
  ...
  function Ai(e, t) {
    ...
    return (n.cache = new (Ai.Cache || Kr)()), n
  }
  Ai.Cache = Kr
  var Ri = 500
  var Pi,
  ...
  function ua(e, t, n) {
    var r = +X(n.start(e), 'day') - +X(n.start(t), 'day'),
  ...
  var xa = function(e, t) {
    ...
    Ta = function(e, t, n, r) {
      return +X(e, 'minutes') + '' + +X(t, 'minutes') + n + '-' + r
    }
  function ja(e) {
    for (
      var t = e.min,
    ...
    return (
      ...
      (o.render = function() {
        var e = this.props,
          ...
          a = e.accessors,
          c = e.localizer,
          l = e.calendarChildren,
          u = e.getters,
          f = u.dayProp,
          d = s(u, ['dayProp']),
          p = e.components,
          h = p.eventContainerWrapper,
          m = s(p, ['eventContainerWrapper']),
          v = this.slotMetrics,
          g = this.state,
          y = g.selecting,
          b = g.top,
        ...
        return r.createElement(
          ...
          y &&
            r.createElement(
              'div',
              { className: 'rbc-slot-selection', style: { top: b, height: w } },
              r.createElement('span', null, c.format(E, 'selectRangeFormat'))
            ),
          o &&
    ...
    function t(t) {
      ...
      return (
        ...
        (o.handleResize = function() {
          At(o.rafHandle), (o.rafHandle = Rt(o.checkOverflow))
        }),
    ...
    return (
      ...
      (o.renderEvents = function(e, t, n) {
        var o = this,
          ...
          p = i.calendarChildren,
          h = this.memoizedResources(this.props.resources, u),
          m = h.groupEvents(t)
        return h.map(function(t, i) {
          var h = t[0],
            v = t[1]
          return e.map(function(e, t) {
            var g = (m.get(h) || []).filter(function(t) {
  ...
  ;(ps.propTypes = {}),
    ...
    (ps.range = function(e, t) {
      ...
      return ye(X(e, 'week', n), q(e, 'week', n))
    }),
        ...
        return (
          i.allDay(t) ||
            (K(u, l)
              ...
              : K(e, u, 'day')
              ? (c = a.format(u, 'agendaTimeFormat'))
              : K(e, l, 'day') && (c = a.format(l, 'agendaTimeFormat'))),
        ...
        if (m.current) {
          ...
          if (t) {
            var n,
              ...
              i = [],
              a = i
            ;(i = [as(t.children[0]), as(t.children[1])]),
              (a[0] === i[0] && a[1] === i[1]) ||
              ...
              o
                ...
                : (function(e, t) {
                    e.classList
                      ...
                      ? (e.className = gs(e.className, t))
                      : e.setAttribute(
                          'class',
                          gs((e.className && e.className.baseVal) || '', t)
                        )
                    ...
                    w.map(function(e, t) {
                      return (function(e, t, c) {
                        ...
                        return (t = t.filter(function(t) {
                          return ca(t, X(e, 'day'), q(e, 'day'), i)
                        })).map(function(s, f) {
                          var d = i.title(s),
                            p = i.end(s),
                            h = i.start(s),
                            m = o.eventProp(s, h, p, Ft(s, n)),
  ...
  ;(vs.propTypes = {}),
    (vs.defaultProps = fs.defaultProps),
    (vs.range = hs),
    (vs.navigate = ps.navigate),
  ...
  function Ms(e, t, n) {
    var r = e[t]
    ;(Ss.call(e, t) && Oe(r, n) && (void 0 !== n || t in e)) || Os(e, t, n)
  }
  function Ds(e, t, n, r) {
    var o = !n
    n || (n = {})
  ...
  var Ns = 'object' == typeof e && e && !e.nodeType && e,
    ...
    As = ks ? ks.allocUnsafe : void 0
  var Rs = Qo(Object.getPrototypeOf, Object),
    Ps = Object.getOwnPropertySymbols
      ? function(e) {
          for (var t = []; e; ) So(t, No(e)), (e = Rs(e))
          return t
        }
      : xo
  function Fs(e) {
  ...
  function Ac(e) {
    return (null == e ? 0 : e.length) ? Aa(e, 1) : []
  }
  var Rc = (function(e) {
      return $a(Wa(e, void 0, Ac), e + '')
    })(function(e, t) {
      var n = {}
      if (null == e) return n
      var r = !1
    ...
    Lc = Ga(function(e, t) {
      ...
      for (o && qe(t[0], t[1], o) && (r = 1); ++n < r; )
        for (var i = t[n], a = js(i), s = -1, c = a.length; ++s < c; ) {
          var l = a[s],
            u = e[l]
          ;(void 0 === u || (Oe(u, Pc[l]) && !Fc.call(e, l))) && (e[l] = i[l])
        }
      return e
    })
  var Ic = function(e) {
  ...
  var Gc = function(e, t, n) {
    ...
    Xc = {
      ...
      dayFormat: 'eee dd/MM',
      weekdayFormat: 'eee',
      selectRangeFormat: Gc,
      eventTimeRangeFormat: Gc,
      eventTimeRangeStartFormat: function(e, t, n) {
        var r = e.start
